...
public class ECal3 implements ActionListener,Runnable {
	JFrame f1;
	...
	float unit,Month,PBA;
	float kWhCharge, FixedCharge,TotBAmount, TotAmount, LPICharge;
